const CACHE='noan-horror-v1';
const SHELL=['./','./index.html','./design.css','./manifest.webmanifest','./stories.json','./narrator.js','./favicon-32x32.png','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./voice/am_granite.bin'];
